...
public class XrAudioManager : MonoBehaviour
{
    ...
    const string FallBackClip_Name = "fallBackClip";
    ...
    private void SetRobot()
    {
        ...
        destroyWallCubeSound.playOnAwake = false;
        destroyWallCubeSound.clip = joystickClip;
    ...
    private void SetJoystick()
    {
        ...
        joystickSound.playOnAwake = false;
    ...
    void SetCabinetDoors(int index)
    {
        ...
        cabinetDoorSound[index].playOnAwake = false;
    ...
    void OnDoorStop(SelectExitEventArgs arg0)
    {
        for (int i = 0; i < cabinetDoors.Length; i++)
        {
    ...
    void OnDoorMove(SimpleHingeInteractable arg0)
    {
        for (int i = 0; i < cabinetDoors.Length; i++)
        {
    ...
    void SetComboLock()
    {
        ...
        comboLockSound.playOnAwake = false;
    ...
    void OnComboUnlocked()
    {
        comboLockSound.clip = unlockComboClip;
        comboLockSound.Play();
    }

    void SetWallInteractable()
    {
        ...
        if (wallSocket != null)
        {
            ...
            wallSocketSound.playOnAwake = false;
            wallSocketClip = wall.GetSocketedClip;
    ...
    void OnWallSocketed(SelectEnterEventArgs arg0)
    {
        wallSocketSound?.Play();
    }

    void CheckClip(ref AudioClip clip)
    {
        if (clip == null)
        {
            clip = fallBackClip;
    ...
    void OnDrawerStop(SelectExitEventArgs arg0)
    {
        drawerSound.Stop();
    }

    void OnDrawerMove(SelectEnterEventArgs arg0)
    {
        if (isDetached)
        {
    ...
    void OnDrawerSocketed(SelectEnterEventArgs arg0)
    {
        drawerSocketSound?.Play();
        grabSound.Play();
    }

    void OnActivatedGrabbable(ActivateEventArgs arg0)
    {
    ...
    void OnSelectExitGrabbable(SelectExitEventArgs arg0)
    {
        PlayGrabSound(grabClip);
    }

    void OnSelectEnterGrabbable(SelectEnterEventArgs arg0)
    {
